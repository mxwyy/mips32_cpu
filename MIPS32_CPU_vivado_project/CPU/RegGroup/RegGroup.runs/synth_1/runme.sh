...
HD_PWD='E:/vivado_project/CPU/RegGroup/RegGroup.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegGroup.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RegGroup.tcl
