...
HD_PWD='E:/vivado_project/CPU/InsSub/InsSub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InsSub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InsSub.tcl
