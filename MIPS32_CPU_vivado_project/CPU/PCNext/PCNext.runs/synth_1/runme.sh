...
HD_PWD='E:/vivado_project/CPU/PCNext/PCNext.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCNext.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCNext.tcl
