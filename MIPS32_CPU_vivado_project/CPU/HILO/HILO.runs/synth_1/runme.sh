...
HD_PWD='E:/vivado_project/CPU/HILO/HILO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HILO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HILO.tcl
